...
//
        ...
        newsList.add(new News(museumList.get(1), "Flujos Deseantes en la Universidad Nacional", "Esta exposición del artista colombiano Juan Fernando Herrán es una revisión de su obra entre 1987 y 1993. Se trata de la época más temprana de su trabajo, caracterizada por la experimentación e intuición en la transformación de materiales tan disímiles como el pelo humano, el plomo, el material vegetal, la fotografía, el estiércol, la arcilla y el video.", 2, 02, 2010,R.drawable.news_flujos_deseantes));
        newsList.add(new News(museumList.get(5), "Reptiles en la Universidad Nacional", "Incluye el montaje de un esqueleto de más de 3,20 metros de longitud, correspondiente a una de las especies más grandes del mundo: Cocodrilus intermedius, en peligro de extinción. También se exhiben ejemplares en taxidermia de tortugas, serpientes, iguanas, cocodrilos y babillas; y el montaje de un esqueleto completo de una Anaconda (Eunectes sp.)", 22, 06, 2015,R.drawable.news_reptiles));
        newsList.add(new News(museumList.get(4), "De sangre y plomo", "Cada una de las líneas que éste oaxaqueño dibuja, denotan una amplísima cosmovisión de aquellos lugares en donde creció. Los dibujos realizados son el resultado de la absorción de culturas e imágenes de cada territorio donde residió.  \n" +
        ...
        newsList.add(new News(museumList.get(3), "Proyecciones en el cine domo", "En la ronda de show de luces láser con las bandas más emblemáticas del rock, no podía faltar Pink Floyd.\n" +
                "\n" +
